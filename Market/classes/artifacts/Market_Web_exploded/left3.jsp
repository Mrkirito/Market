...
<ul class="nav">
    ...
    <li><a href="#none">市场营销<i></i></a>
        <ul>
            ...
            <li><a href="#none">定价</a>
                <ul>
                    <li><a href="showProductPrice.do?quarter=3" target="main">产品定价</a></li>
                    <li><a href="showSoldCost.do?quarter=3" target="main">生产成本</a></li>
                    <li><a href="priceOfRival.do?quarter=3" target="main">竞争对手的价格</a></li>
                    <li><a href="priceAndSale.do?quarter=3" target="main">可销售品牌</a></li>
                </ul>
            </li>
            <li><a href="#none">广告</a>
                <ul>
                    <li><a href="adOfRival1.do?quarter=3" target="main">竞争对手的广告</a></li>
            ...
            <!-- <li><a href="ShowCompanyReport.do?quarter=3" target="main">购买市场调研报告</a></li> -->
        </ul>
    </li>
        ...
        <ul>
            ...
            <li><a href="#" target="main">网络销售中心</a>
                <ul>
                    ...
                    <li><a href="hireSalePeopleOnline.do?quarter=3" target="main">雇佣网络销售人员</a></li>
                </ul>
            </li>
    ...
    <li><a href="#none">生产制造<i></i></a>
        <ul>
            ...
            <!-- <li><a href="showUselessInventory.do?quarter=3" target="main">销售无用库存</a></li> -->
    ...
    <li>
        ...
        <ul>
            <li>
                <a href="policyDecision/companyDecisionSummary.do?companyId=<%=request.getParameter("companyId") %> &currentQuarter=3"
