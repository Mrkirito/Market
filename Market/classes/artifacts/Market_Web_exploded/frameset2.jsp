...
<frameset rows="80,540" frameborder="0" framespacing="0" >
        ...
        <frameset cols="190,*"   id="frame">
            ...
            <frame src="left2.jsp" name="leftFrame" noresize="noresize" marginwidth="" marginheight="" frameborder="0" scrolling="no" target="lefts" />
