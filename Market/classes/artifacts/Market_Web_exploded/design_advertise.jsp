                	...
                	<table class="table table-bordered" id="table1">
						...
						<form id="form1" action="" method="post">
							<tr >
								...
								<td>
									<select id="select1" class="selectpicker form-control" onchange="aa()" >
							...
							<tr >
								...
								<td>
									<input type="text" class="form-control" id="text1" name="advertiseName" value="${companyAdvertises[0].getAdvertiseName() }"/>
								</td>
							</tr>
							<tr >
...
<script>
	...
	function aa(){
		...
		if(productName=="请选择产品"){
			$("#form1").attr(
					"action",
					"designAdvertisement.do?quarter="+quarter);
			$("#form1").submit();
		}else{
			var method="query";
			$("#form1").attr(
