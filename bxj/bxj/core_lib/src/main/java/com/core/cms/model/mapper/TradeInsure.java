 ...
 */
public class TradeInsure extends BaseCommonQuery implements Serializable {
    private Integer fid;//
    ...
    private String createTimeTemp1;    //订单创建辅助日期

    private Date createTime1;//订单创建辅助日期

    private String insureBeginDateTemp;//保障开始日期

    private static final long serialVersionUID = 1L;

    public Date getCreateTime1() throws ParseException {
        if (StringUtils.isNotBlank(this.createTimeTemp1)) {
            SimpleDateFormat dfs = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            return dfs.parse(this.createTimeTemp1);
        }
        return createTime1;
    }
    ...
    public String getCreateTimeTemp1() throws ParseException {
        return createTimeTemp1;
    }

    public void setCreateTimeTemp1(String createTimeTemp1) {
        this.createTimeTemp1 = createTimeTemp1;
    }
    ...
    public void setTradeId(String tradeId) {
        this.tradeId = tradeId == "" ? null : tradeId.trim();
    }
    ...
    public void setInsureBeginDateTemp(String insureBeginDateTemp) {
        this.insureBeginDateTemp = insureBeginDateTemp == "" ? null : insureBeginDateTemp;
    }
}