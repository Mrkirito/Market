            ...
            list: function () {
               ...
               listJson = [{
                ...
                var thiz = this, list = listTool.create({
                    ...
                    selector: ".data-list",
                    remote: true,
                    url: serverHost + "/hjreport/queryWchartDataReportList.json",
                    width: 600,
                    height: 900,
                    columns: listJson,
                    idName: "productTable",
...
//                        reportList.dataCharts();						
            ...
            add: function (data) {
                    ...
                    okFn: function (win) {
                        ...
                        if(b){                        	
                        	...
                        	util.request({
                        		confirm: true,
                        		msg: "确定新增推广运营数据吗?",
                        		url: serverHost + "/hjreport/addWchartData.json",
                        		params: para,
                ...
                function displayInfo(ev){
					...
					util.request({
						url: serverHost + "/hjreport/ajaxDisplayInfo.json",
						params: {
							date: year+""+month+""+day
						},
						success: function (resp) {
            ...
            dataCharts: function(){
            	var thiz = this;
        		util.ajax({
                    url: serverHost + "/hjreport/queryWchartMarkDataCharts.json",
                    params: {
                    	date: $('.reportTime').val()
                    },
                    success: function (resp) {
