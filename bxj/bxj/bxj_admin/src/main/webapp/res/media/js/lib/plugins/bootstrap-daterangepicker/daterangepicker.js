  ...
  // Finally, as a browser global.
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    ...
                    '<button class="clearBtn" style="margin-left: 4px;"></button>' +
                  '</div>' +
                '</div>' +
              '</div>';
        ...
        if (this.element.is('input')) {
            ...
            if(this.element.parent().hasClass("input-group")) {
                ...
                showBtn.on("click", $.proxy(this.show, this));
            }
        } else {
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            this.buttonClasses = ['btn', 'btn2', 'btn-small btn-sm'];
            ...
            if(typeof options.applyClick == 'function') {
                this.applyClick = options.applyClick;
            }
        ...
        clickApply: function (e) {
            ...
            this.element.trigger('apply.daterangepicker', this);
            if(this.applyClick) {
                this.applyClick(this.startDate.format(this.format), this.endDate.format(this.format));
            }
        },
