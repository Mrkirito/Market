...
public abstract class ImageUtils {
	...
	public static void zoomAutoFix(Object imageFile, File dstFile, int targetW, int targetH) throws Exception {
		BufferedImage source = readImage(imageFile);
		writeImageAutoFix(source, targetW, targetH, dstFile);
	}
	...
	public static void writeImage(BufferedImage source, String fileType, File dstFile) throws IOException {
		ImageIO.write(source, fileType, dstFile);
	}
